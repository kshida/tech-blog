      ...
      <Container>
        <Box my={10} mx={3}>
          ...
          <Text fontSize='md' mt='24px'>
            当サイトでは、第三者配信の広告サービス（Googleアドセンス、A8.net）を利用しています。<br/>
            ...
            <NavLink link='https://policies.google.com/technologies/ads?gl=jp' isRichStyle={false} isTargetBlank={true}>
              こちら
            </NavLink>
            をご覧ください。
          </Text>
          ...
          <Text fontSize='md' mt='24px'>
            ...
            この規約に関して、詳しくは
            <NavLink link='https://www.google.com/analytics/terms/jp.html' isRichStyle={false} isTargetBlank={true}>
              こちら
            </NavLink>
            をご覧ください。
          </Text>
